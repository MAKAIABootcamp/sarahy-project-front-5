    ...
    <footer id="miFooter" className="footer">
      ...
      <div className="followme">
        ...
        <article className="networks">
          <a
            href="https://www.facebook.com/banquetessarahy?mibextid=LQQJ4d"
            target="_blank"
          >
      ...
      <section className="footer-mobile">
        ...
        <article className="networks">
          ...
          <img
            ...
            src={whatsapp}
            alt=""
            href="https://api.whatsapp.com/send?phone=33003003232&text=Hola%20bienvenido%20a%20Sarahy%20te%20asesoramos%20por%20whatsapp%20gestiona%20tu%20evento%20por%20este%20canal."
          />
        </article>
        <div className="contacto__footer">
          ...
          <span className="span__footer--mobile">
            celebracionessarahy@gmail.com
          </span>
        </div>
        ...
        <span className="span__footer--mobile">
          © 2023 Sarahy. Todos los derechos reservados.
        </span>
      </section>
    </footer>
  );
