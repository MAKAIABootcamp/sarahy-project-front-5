        ...
        <main className='main__allies dark:!bg-neutral-700'>
            ...
            <section className='main__info dark:!bg-neutral-700'>
                ...
                <div className="container__intro">
                    <h1 className='main__title__home dark:!text-neutral-100'>Trabaja con nostros</h1>
                    <p className="main__parrafo dark:!text-neutral-200">
                    En Sarahy Celebraciones, estamos siempre en busca de talento apasionado y creativo en el mundo de los eventos. Si compartes nuestra pasión por la planificación y organización de eventos excepcionales, te invitamos a considerar unirse a nuestro equipo. Si estas interesado rellena al final el formulario y nos contactaremos contigo
                    </p>
