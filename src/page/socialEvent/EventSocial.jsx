    ...
    <section className='eventSocial'>
      ...
      <main className='containerEventSocial'>
        ...
        <section className='listsEventsSocial'>
          ...
          <CardEventSocial imageIcon={'https://i.ibb.co/kxyPX19/Rectangle-2-1.png'} image={'https://i.ibb.co/CvbSC50/image-14.png'} text={'Celebra tu día especial con una fiesta única.'} name={'Cumpleaños'} ruta={'/cumpleaños'}/>
