    ...
    <section className='eventSocial'>
      ...
      <main className='containerEventSocial'>
        ...
        <section className='listsEventsSocial'>
          ...
          <CardEventSocial imageIcon={'https://i.ibb.co/wQQWs9w/Layer-3.png'} image={'https://i.ibb.co/8cpdmPY/image-10.png'} text={'Organizamos y Diseñamos bodas inolvidables a tu medida.'} name={'Body'} ruta={'/boda'} />
