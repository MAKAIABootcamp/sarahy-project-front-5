...
const Quote = () => {
      ...
      serviceCatering.map((subobjeto) => (
        <span>
          <input
            ...
            id={subobjeto.key}
            name="catering[]"
            value={subobjeto.name}
            input
            {...register("catering", { required: true })}
          />
          <label className="titleOptionService" for={subobjeto.key}>
  ...
  useEffect(() => {
    console.log(
      "AQUÍ SE PUEDE PONER LÓGICA QUE DEPENDA DEL CAMBIO DE ALGÚN INPUT DE SERVICIO"
    );
      ...
      <main className="main__home">
        ...
        <section className="main__info dark:bg-neutral-800">
          ...
          <div className="container__intro">
            <h1 className="main__title__home dark:text-neutral-100">
              Cotización
            </h1>
            <p className="main__parrafo dark:text-neutral-300">
              ...
              personalizada que se adapte a tus necesidades y haga que tu
              ocasión sea inolvidable!
            </p>
          </div>
        ...
        <section className="formQuote">
          <form
            ...
            className="loginDown__form dark:bg-neutral-400"
          >
            <input
              type="text"
              id="empresa"
            ...
            <input
              type="text"
              id="type__Event"
              {...register("type__Event", { required: true })}
            ...
            <input
              ...
              placeholder="Número Estimado de Asistentes al Evento"
              className="loginDown__input"
            />
            {errors.attendees && (
              <span className="loginDown__error">
            ...
            <span className="selectServices">
              SELECCIONA LOS SERVICIOS QUE DESEAS EN EL EVENTO
            </span>
            <Swiper
              spaceBetween={30}
              centeredSlides={true}
            ...
            >
              <SwiperSlide className="sliderForm">
                <img
                  className="imageSliderForm"
                  src="https://i.ibb.co/g9j4DKT/image-128.png"
                  alt="imagen de bodas"
                />
                ...
                <section className="optionsSliderForm">
                  ...
                  <div className="service">
                    <div className="service__options">{cateringHTML}</div>
                  </div>
                </section>
              </SwiperSlide>
              ...
              <SwiperSlide className="sliderForm">
                <img
                  className="imageSliderForm"
                  src="https://images.unsplash.com/photo-1495745966610-2a67f2297e5e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80"
                  alt="imagen de bodas"
                />

                <section className="optionsSliderForm">
                  <span className="loginLabel">Fotografía</span>
                  <div className="service__options">{fotoHTML}</div>
                </section>
              </SwiperSlide>
              ...
              <SwiperSlide className="sliderForm">
                <img
                  className="imageSliderForm"
                  src="https://images.unsplash.com/photo-1554778414-74925d96d495?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1376&q=80"
                  alt="imagen de bodas"
                />
                ...
                <section className="optionsSliderForm">
                  ...
                  <div className="service__options">{decorHTML}</div>
                </section>
              </SwiperSlide>
              ...
              <SwiperSlide className="sliderForm">
                <img
                  className="imageSliderForm"
                  src="https://images.unsplash.com/photo-1438762398043-ac196c2fa1e7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80"
                  alt="imagen de bodas"
                />

                <section className="optionsSliderForm">
                  <span className="loginLabel" onClick={() => setFour(!four)}>
                    Animación
                  </span>
                  <div className="service__options">{animationHTML}</div>
                </section>
              </SwiperSlide>
              ...
              <SwiperSlide className="sliderForm">
                <img
                  className="imageSliderForm"
                  src="https://images.unsplash.com/photo-1562575214-da9fcf59b907?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1372&q=80"
                  alt="imagen de bodas"
                />
                ...
                <section className="optionsSliderForm">
                  ...
                  <div className="service__options">{iluminationgHTML}</div>
                </section>
              </SwiperSlide>
              ...
              <SwiperSlide className="sliderForm">
                <img
                  className="imageSliderForm"
                  src="https://plus.unsplash.com/premium_photo-1682391039360-01afb6ffc72f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZGp8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
                  alt="imagen de bodas"
                />
                ...
                <section className="optionsSliderForm">
                  ...
                  <div className="service__options">{musicHTML}</div>
                </section>
              </SwiperSlide>
            </Swiper>
            <button type="submit" className="generation">
              Generar Cotización
            </button>
            <span
